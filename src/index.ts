...
<header><div><h1>Market Pulse</h1><small>V1.2.1 · Capital.com · Signal Engine</small></div><span class="badge">DEMO · READ ONLY</span></header>
...
$('refresh').onclick=refresh;$('history').onclick=history;$('signal').onclick=analyzeSignal;
